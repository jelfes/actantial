...
![Greimas' Actantial Model](figures/actantial_model.png)
...
A specific narrative is represented by its _semantic investment_, that is, the manifestation of each actant as a concrete actor or object in the narrative. A minimal example from the mythical origins of the model would read as follows: a prince (Subject) desires land (Object), which the king (Sender) will bestow upon him (Receiver), should he overcome the dark knight (Opponent), aided by a magical companion (Helper).
